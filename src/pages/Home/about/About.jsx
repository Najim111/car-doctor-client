            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div className='lg:w-1/2'>
                        <h3 className='text-3xl text-[#FF3811] font-bold mb-5'>About Us</h3>
                        <h1 className="text-5xl text-black w-[376px] mb-8 font-bold ">We are qualified & of experience in this field</h1>
